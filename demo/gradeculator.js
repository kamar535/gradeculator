...
var $author$project$Main$assignmentsPart1Points = {
	assignments: A3(
...
var $author$project$Main$assignmentsPart2 = {assignments: $author$project$Main$singleGrade345, code: '5000', credits: 1, name: 'Assignments (part 2)', symbol: 'A_2'};
var $author$project$Main$projectGroup = {assignments: $author$project$Main$singleGrade345, code: '6000', credits: 2, name: 'Project (group)', symbol: 'P_g'};
var $author$project$Main$projectIndividual = {assignments: $author$project$Main$singleGrade345, code: '7000', credits: 5, name: 'Project (individual)', symbol: 'P_i'};
var $author$project$Main$writtenExam = {assignments: $author$project$Main$singleGrade345, code: '3000', credits: 1, name: 'Written exam (part 1)', symbol: 'E'};
var $author$project$Main$osppModel = $elm$core$Array$fromList(
	_List_fromArray(
		[$author$project$Main$assignmentsPart1Points, $author$project$Main$writtenExam, $author$project$Main$assignmentsPart2, $author$project$Main$projectGroup, $author$project$Main$projectIndividual]));
var $author$project$Main$init = _Utils_Tuple2($author$project$Main$osppModel, $elm$core$Platform$Cmd$none);
		...
		switch (_v0.$) {
			case 'FailPassPoints':
				...
				return _Utils_update(
					m,
					{
						assignments: $author$project$Main$FailPassPoints(
							_Utils_update(
								assignments,
				...
				if (!points) {
					var newAssignments = A3(
						...
						function (a) {
							return _Utils_update(
								a,
								{mandatoryPass: false, points: points});
						},
						assignments.assignments);
					return _Utils_update(
						m,
						{
							assignments: $author$project$Main$PointsOnly(
								_Utils_update(
									assignments,
									{assignments: newAssignments}))
						});
					...
					var newAssignments = A3(
						...
						function (a) {
							return _Utils_update(
								a,
								{mandatoryPass: true, points: points});
						},
						assignments.assignments);
					return _Utils_update(
						m,
		...
		switch (msg.$) {
			...
			case 'SetMandatoryPass':
				...
				var newModel = A3(
					...
					model);
				return _Utils_Tuple2(newModel, $elm$core$Platform$Cmd$none);
			case 'SetFailPassPointsPointsGradePoints':
				var moduleIndex = msg.a;
				var assignmentIndex = msg.b;
				var points = msg.c;
				var newModel = A3(
...
var $author$project$Main$numberOfAssignments = function (m) {
	var _v0 = m.assignments;
	switch (_v0.$) {
		case 'AverageGrade345':
			var a = _v0.a;
			return $elm$core$Array$length(a);
		case 'FailPassPoints':
			var a = _v0.a;
			return $elm$core$Array$length(a.assignments);
		case 'PointsOnly':
			var a = _v0.a;
			return $elm$core$Array$length(a.assignments);
		default:
...
var $author$project$Main$FailPassPointsModuleGrade = function (a) {
	return {$: 'FailPassPointsModuleGrade', a: a};
};
...
var $author$project$Main$pointsGrade = function (assignments) {
	return $author$project$Main$FailPassPointsModuleGrade(
		$author$project$Main$pointsGradeHelper(assignments));
};
var $author$project$Main$PointsOnlyModuleGrade = function (a) {
	return {$: 'PointsOnlyModuleGrade', a: a};
};
var $author$project$Main$pointsOnlyGradeHelper = F2(
	function (assignments, passOffset) {
		return function (_v0) {
			var allMandatoryPass = _v0.a;
			var points = _v0.b;
			var max = _v0.c;
			var grade = allMandatoryPass ? $elm$core$Maybe$Just(
				A3($author$project$Main$pointsToGrade345, points - passOffset, assignments.four, assignments.five)) : $elm$core$Maybe$Nothing;
			return {five: assignments.five, four: assignments.four, grade: grade, max: max, points: points};
		}(
			A3(
				$elm$core$Array$foldl,
...
var $author$project$Main$pointsOnlyGrade = F2(
	function (assignments, passOffset) {
		return $author$project$Main$PointsOnlyModuleGrade(
			A2($author$project$Main$pointsOnlyGradeHelper, assignments, passOffset));
	});
var $author$project$Main$moduleGrade = function (m) {
	...
	switch (_v0.$) {
		...
		default:
			var assignments = _v0.a;
			return A2(
				$author$project$Main$pointsOnlyGrade,
				assignments,
				$author$project$Main$numberOfAssignments(m));
	}
};
var $author$project$Main$moduleGradeToMaybeInt = function (grade) {
	switch (grade.$) {
		...
		case 'FailPassPointsModuleGrade':
			var g = grade.a;
...
var $author$project$Main$FailPassPointsAssignmentRow = function (a) {
	return {$: 'FailPassPointsAssignmentRow', a: a};
};
var $author$project$Main$FailPassPointsModuleRow = function (a) {
	return {$: 'FailPassPointsModuleRow', a: a};
};
var $author$project$Main$PointsOnlyAssignmentRow = function (a) {
	return {$: 'PointsOnlyAssignmentRow', a: a};
};
var $author$project$Main$PointsOnlyModuleRow = function (a) {
	return {$: 'PointsOnlyModuleRow', a: a};
};
...
var $author$project$Main$moduleTableRows = F2(
	function (moduleIndex, m) {
		...
		switch (_v0.$) {
			...
			case 'FailPassPoints':
				...
				return A2(
					...
					A2(
						...
						F2(
							function (assignmentIndex, assignment) {
								return $author$project$Main$FailPassPointsAssignmentRow(
			...
			default:
				var assignments = _v0.a;
				var n = $author$project$Main$numberOfAssignments(m);
				var grade = A2($author$project$Main$pointsOnlyGradeHelper, assignments, n);
				return A2(
					$elm$core$List$cons,
					...
					A2(
						...
						F2(
							function (assignmentIndex, assignment) {
								return $author$project$Main$PointsOnlyAssignmentRow(
									{assignmentIndex: assignmentIndex, mandatoryPass: assignment.mandatoryPass, max: assignment.max, moduleIndex: moduleIndex, name: assignment.name, points: assignment.points});
							}),
						$elm$core$Array$toList(assignments.assignments)));
		}
	...
	switch (row.$) {
		...
		case 'PointsOnlyModuleRow':
			...
			return A2(
				...
				$mdgriffith$elm_ui$Element$text(
					A3($author$project$Main$viewPointsModuleGrade, r.grade, r.points, r.max)));
		case 'FailPassPointsAssignmentRow':
			var r = row.a;
			return A2(
				$author$project$Main$cell,
				_List_Nil,
				A3($author$project$Main$mandatoryPassButtons, r.moduleIndex, r.assignmentIndex, r.mandatoryPass));
		case 'PointsOnlyAssignmentRow':
			return A2($author$project$Main$cell, _List_Nil, $mdgriffith$elm_ui$Element$none);
		case 'SingleGrade345ModuleRow':
			var r = row.a;
			return A2(
				$author$project$Main$cell,
...
var $author$project$Main$SetFailPassPointsPointsGradePoints = F3(
	function (a, b, c) {
		return {$: 'SetFailPassPointsPointsGradePoints', a: a, b: b, c: c};
	});
	...
	function (moduleIndex, assignmentIndex, points, selected) {
		return A2(
			...
			_List_Nil,
			{
				...
				onChange: A2($author$project$Main$SetFailPassPointsPointsGradePoints, moduleIndex, assignmentIndex),
				options: A3(
					$author$project$Main$mkOptions,
					A2($elm$core$List$range, 0, points),
					$elm$core$String$fromInt,
					function (_v0) {
						return $author$project$Main$color.blue;
					}),
				selected: $elm$core$Maybe$Just(selected)
			});
	});
...
var $author$project$Main$SetPointsOnlyPoints = F3(
	function (a, b, c) {
		return {$: 'SetPointsOnlyPoints', a: a, b: b, c: c};
	});
var $author$project$Main$pointsOnlyButtons = F4(
	function (moduleIndex, assignmentIndex, points, selected) {
		var theColor = function (point) {
			switch (point) {
				case 0:
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					{
						label: $mdgriffith$elm_ui$Element$Input$labelHidden('Select higher grade points'),
						onChange: A2($author$project$Main$SetPointsOnlyPoints, moduleIndex, assignmentIndex),
						options: A3(
							$author$project$Main$mkOptions,
...
var $author$project$Main$viewPointsOnlyLadderHelper = F2(
	function (g, _v0) {
		var grade = _v0.a;
		var points = _v0.b;
		var weight = _Utils_eq(g, grade) ? $mdgriffith$elm_ui$Element$Font$bold : $mdgriffith$elm_ui$Element$Font$regular;
...
var $author$project$Main$viewPointsOnlyLadder = function (_v0) {
	var grade = _v0.a;
	var pl = _v0.b;
	return A2(
		$mdgriffith$elm_ui$Element$row,
		...
		A2(
			$elm$core$List$map,
			$author$project$Main$viewPointsOnlyLadderHelper(grade),
			pl));
};
	...
	switch (row.$) {
		...
		case 'PointsOnlyModuleRow':
			...
			return A2(
				$author$project$Main$cell,
				_List_Nil,
				$author$project$Main$viewPointsOnlyLadder(
					A4($author$project$Main$pointLadder, r.points, r.four, r.five, r.max)));
		case 'FailPassPointsAssignmentRow':
			var r = row.a;
			return A2(
		...
		case 'PointsOnlyAssignmentRow':
			...
			return A2(
				$author$project$Main$cell,
				_List_Nil,
				A4($author$project$Main$pointsOnlyButtons, r.moduleIndex, r.assignmentIndex, r.max, r.points));
		case 'SumRow':
			return A2(
				$author$project$Main$cell,
				_List_fromArray(
