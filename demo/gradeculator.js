...
var $author$project$Main$a2 = {code: '5000', credits: 1, grades: $author$project$Main$singleGrade, name: 'Assignments (part 2)'};
var $author$project$Main$e = {code: '3000', credits: 1, grades: $author$project$Main$singleGrade, name: 'Written exam (part 1)'};
var $author$project$Main$pg = {code: '6000', credits: 2, grades: $author$project$Main$singleGrade, name: 'Project (group)'};
var $author$project$Main$pi = {code: '7000', credits: 5, grades: $author$project$Main$singleGrade, name: 'Project (individual)'};
var $author$project$Main$osppModules = $elm$core$Array$fromList(
	_List_fromArray(
		[$author$project$Main$a1, $author$project$Main$e, $author$project$Main$a2, $author$project$Main$pg, $author$project$Main$pi]));
...
var $author$project$Main$modulesTable = function (modules) {
	...
	return A2(
		...
		_List_Nil,
		{
			...
			data: $author$project$Main$modulesToRows($author$project$Main$osppModules)
		});
};
...
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Main$osppModules, update: $author$project$Main$update, view: $author$project$Main$view});
